const positive = new Set(["RESEARCHED","CONTACTS_FOUND","APPROVED","SENT","REPLIED","WON","COMPLETED","SUCCEEDED","CONNECTED","ACTIVE_CONVERSATION"]);
const warning = new Set(["MEDIUM","PENDING_REVIEW","NEEDS_CHANGES","NEED_REVIEW","IN_PROGRESS","QUEUED","RUNNING","PROPOSAL_SENT","NEGOTIATION","TODAY","REVIEW"]);
