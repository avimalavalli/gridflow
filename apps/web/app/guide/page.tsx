...
export default function GuidePage() {
  ...
  return (
    <Shell title="Guided start">
      <PageHead eyebrow="Revisitable tutorial" title="Learn GridFlow by following the real workflow" description="Seven short chapters explain what GridFlow automates, what remains yours, and where to perform each task. Your place is saved across devices." action={<Link className="button button-secondary" href="/help">Open full manual <ExternalLink size={14}/></Link>} />
