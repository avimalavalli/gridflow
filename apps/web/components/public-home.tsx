...
export function PublicHome() {
  return <PublicShell>
    ...
    <section className="public-section"><div className="public-section-head"><div className="public-kicker">One connected commercial record</div><h2>Less coordination overhead. More time on the work that matters.</h2></div><div className="public-feature-grid"><article><Bot/><h3>Commercial intelligence</h3><p>Structured support for discovery, research, contacts, outreach, replies, meetings and commercial documents.</p></article><article><Workflow/><h3>End-to-end continuity</h3><p>Every next step inherits verified context instead of restarting in another spreadsheet, inbox or document.</p></article><article><Gauge/><h3>Automation with boundaries</h3><p>Routine internal work can run inside budgets and quiet hours. Sending, money, legal terms and relationship decisions stay controlled.</p></article><article><FileCheck2/><h3>Evidence at every decision</h3><p>Sources, approvals, version history, delivery proof and renewal facts remain inspectable at the point of decision.</p></article></div></section>
  </PublicShell>;
}
