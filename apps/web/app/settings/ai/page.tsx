...
export default async function AiSettingsPage() {
  try {
    ...
    return <Shell title="AI Setup"><PageHead title="Intelligence and usage" description="Connect the organisation's Gemini key and see exactly which GridFlow agents—including Forge—use grounded intelligence."/><AiSettingsClient data={data}/></Shell>;
  } catch (cause) {
