...
export function ContactEditor({
  ...
  async function save(e: React.FormEvent) {
    ...
    setMsg("");
    try {
      const r = await fetch(`/backend/contacts/${contact.id}`, {
        method: "PATCH",
        credentials: "include",
    ...
    <form className="stack" onSubmit={save}>
      ...
      <div className="field">
        ...
        <select
          ...
          onChange={(e) =>
            setForm({ ...form, contactPriority: e.target.value })
          }
        >
      ...
      <div className="field">
        ...
        >
          {["EMAIL", "LINKEDIN", "PHONE", "EMAIL_AND_LINKEDIN", "UNKNOWN"].map(
            (value) => (
              <option value={value} key={value}>{formatLabel(value)}</option>
            ),
          )}
