...
export default async function DeliveryPage() {
  ...
  return <Shell title="Delivery">
    <PageHead eyebrow="Partnership fulfilment" title="Partnership delivery" description="Manage contract obligations, deadlines, verified evidence, sponsor reports and renewal readiness." />
