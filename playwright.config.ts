  ...
  webServer: [
    {
      ...
      env: {
        ...
        PLATFORM_ADMIN_EMAILS: [
          "phase51-chromium-0@example.test", "phase51-chromium-1@example.test",
          "phase51-firefox-0@example.test", "phase51-firefox-1@example.test",
          "phase51-webkit-0@example.test", "phase51-webkit-1@example.test",
          "phase51-mobile-chromium-0@example.test", "phase51-mobile-chromium-1@example.test",
          "phase51-tablet-webkit-0@example.test", "phase51-tablet-webkit-1@example.test",
        ].join(","),
        ...
        OPENAI_INPUT_COST_PER_MILLION_USD: "0.25",
        OPENAI_OUTPUT_COST_PER_MILLION_USD: "2.00",
